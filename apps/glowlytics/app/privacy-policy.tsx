...
export default function TermsAndPrivacyScreen() {
  ...
  return (
    <AtmosphereScreen>
      ...
      <View style={styles.card}>
        <Section title="8. Termination">
          <Paragraph>
            ...
            {CONTACT_EMAIL} or by using the "Delete account" option in the
            Profile screen of the app.
      ...
      {/* 14. Data Storage */}
      <View style={styles.card}>
        <Section title="13A. Face Data and Facial Geometry">
          <Paragraph>
            When you open the guided camera, Glowlytics processes limited face
            data on-device so it can align your scan consistently. This face data
            may include a face bounding box, approximate face size, head angle,
            and facial landmark / mesh coordinates during live preview.
          </Paragraph>
          <BulletList
            items={[
      ...
      <View style={styles.card}>
        <Section title="17. Data Retention and Deletion">
          <Paragraph>
            ...
            app by using the "Delete account" option, or by contacting us at{' '}
            {CONTACT_EMAIL}.
          </Paragraph>
          <Paragraph>
      ...
      <View style={styles.card}>
        <Section title="18. Camera and Photo Permissions">
          <Paragraph>
            ...
            captured during scans may include your face and are handled as follows:
          </Paragraph>
          <BulletList
            items={[
      ...
      <View style={styles.card}>
        <Section title="19A. Clinical Sources">
          <Paragraph>
            Glowlytics recommendations are grounded in public medical guidance.
            Users and reviewers can access the primary source pages here:
          </Paragraph>
          <View style={styles.linkButtonStack}>
            <TouchableOpacity
              style={styles.linkButton}
              onPress={() => Linking.openURL('https://www.aad.org/public/diseases/acne/derm-treat/treat').catch(() => {})}
              activeOpacity={0.7}
            >
              <Feather name="external-link" size={16} color={Colors.primaryLight} />
              <Text style={styles.linkButtonText}>AAD Acne Care</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.linkButton}
              onPress={() => Linking.openURL('https://www.aad.org/public/skin-hair-nails/skin-care/sunscreen/choosing-the-right-sunscreen').catch(() => {})}
              activeOpacity={0.7}
            >
              <Feather name="external-link" size={16} color={Colors.primaryLight} />
              <Text style={styles.linkButtonText}>AAD Sunscreen Guidance</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.linkButton}
              onPress={() => Linking.openURL('https://www.acog.org/womens-health/infographics/the-menstrual-cycle').catch(() => {})}
              activeOpacity={0.7}
            >
              <Feather name="external-link" size={16} color={Colors.primaryLight} />
              <Text style={styles.linkButtonText}>ACOG Menstrual Cycle</Text>
            </TouchableOpacity>
          </View>
        </Section>
      </View>
      ...
      <View style={styles.card}>
        <Section title="22. Contact Information">
          ...
          <View style={styles.linkButtonStack}>
            ...
            >
              <Feather name="external-link" size={16} color={Colors.primaryLight} />
              <Text style={styles.linkButtonText}>Apple Standard EULA</Text>
            </TouchableOpacity>
          </View>
        </Section>
      </View>
