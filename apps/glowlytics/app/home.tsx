    ...
    <AtmosphereScreen>
      ...
      {overallInsight ? (
        ...
        <Animated.View entering={FadeInDown.duration(500).delay(150)} style={styles.emptyHero}>
          ...
          <Text style={styles.emptyHeroCopy}>
            Your skin score appears here once you capture your first scan.
          </Text>
          <Button title="Start your first scan" onPress={() => handleScanPress('/scan/camera')} />
        </Animated.View>
      )}
      ...
      {!latestOutput && (
        <View style={styles.emptyState}>
          <Text style={styles.emptyTitle}>Trends start with your first scan</Text>
          <Text style={styles.emptyCopy}>
            Once you capture a baseline, you'll see signal trends and detailed assessments here.
          </Text>
        </View>
      )}
