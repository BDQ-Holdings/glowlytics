...
export const GlowPalettes: Record<'dusk' | 'meadow' | 'rose', GlowPalette> = {
  dusk:   { bg: '#F5EFE8', surface: '#FBF7F2', ink: '#2A1F2D', muted: '#7A6A75', accent: '#5A3A5E', accent2: '#D9A28B', glow: '#E8C9B8' },
  meadow: { bg: '#EEF1EA', surface: '#F8FAF4', ink: '#1F2A24', muted: '#6E7A72', accent: '#3D6B52', accent2: '#C9B786', glow: '#CFE0C8' },
...
export const Glow = {
  ...
  motion: {
    ...
    scale: 800,
    breathe: 3200,
    easingOutCubic: [0.215, 0.61, 0.355, 1] as const,
    easingOutExpo: [0.16, 1, 0.3, 1] as const,
    easingSine: [0.4, 0, 0.6, 1] as const,
  },
};
