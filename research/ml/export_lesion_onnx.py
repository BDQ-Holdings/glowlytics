...
Input:  ../apps/glowlytics/backend/models/lesion_yolov8_best.pt
Output: ../apps/glowlytics/backend/models/lesion_detector.onnx
"""
...
MODELS_DIR = Path(__file__).resolve().parent.parent.parent / "apps" / "glowlytics" / "backend" / "models"
